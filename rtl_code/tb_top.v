...
module tb_riscv_pipeline_full();
    ...
    wire [31:0] reg_x3  = dut.decode_stage.register_file.register[3];
    wire [31:0] reg_x7  = dut.decode_stage.register_file.register[7];
    wire [31:0] reg_x10 = dut.decode_stage.register_file.register[10];
    wire [31:0] reg_x31 = dut.decode_stage.register_file.register[31]; // Status flag register
