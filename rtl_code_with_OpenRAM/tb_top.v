...
module tb_riscv_pipeline_full();
    ...
    wire [31:0] reg_x3  = dut.decode_stage.register_file.rf_macro_1.mem[3];
    wire [31:0] reg_x7  = dut.decode_stage.register_file.rf_macro_1.mem[7];
    wire [31:0] reg_x10 = dut.decode_stage.register_file.rf_macro_1.mem[10];
    wire [31:0] reg_x31 = dut.decode_stage.register_file.rf_macro_1.mem[31]; // Status flag register
    ...
    initial begin
        ...
        $readmemh("memfile.hex", dut.fetch_stage.instruction_memory.imem_macro.mem);
